...
if [[ ! -d bootstrap-ghc ]]; then
  ...
  settings_file="${_topdir}"/settings
  ...
  settings_file="${_installdir}"/settings
  ...
  echo "Fake mingw directory created at ${PREFIX}/ghc-bootstrap/mingw" | cat >> "${_installdir}"/mingw/include/__unused__
  echo "Fake mingw directory created at ${PREFIX}/ghc-bootstrap/mingw" | cat >> "${_installdir}"/mingw/lib/__unused__
  echo "Fake mingw directory created at ${PREFIX}/ghc-bootstrap/mingw" | cat >> "${_installdir}"/mingw/bin/__unused__
  echo "Fake mingw directory created at ${PREFIX}/ghc-bootstrap/mingw" | cat >> "${_installdir}"/mingw/share/__unused__
fi
